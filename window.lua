...
local function ReportToChat(frame, chatType)
  ...
  SendChatMessage("TerrorMeter - " .. seg .. " " .. name .. ":", chatType)
  
  frame.values = frame.GetCaps(frame.segment, frame.values)
  local i = 1
  for unitname, unitdata in spairs(frame.segment, sort) do
    if i <= 10 then
      frame.values.name = unitname
      frame.values = frame.GetData(unitdata, frame.values)
      local a = template.bar_string_params
      local chat = string.format(template.chat_string,
        frame.values[a[1]], frame.values[a[2]], frame.values[a[3]], frame.values[a[4]], frame.values[a[5]])
      SendChatMessage(i .. ". " .. frame.values.name .. " " .. chat, chatType)
      i = i + 1
    end
  end
end
...
local function Refresh(self, force, report)
  ...
  if force then
    ...
    elseif config[wid].view == 5 then
      self.btnThreat.caption:SetTextColor(1,.9,0,1)
      self.btnMode.caption:SetText("Threat")
    end
...
local function CreateWindow(wid)
  ...
  frame.title:SetTexture(0,0,0,.9)
  ...
  frame.btnMode.tooltip = { "Select Mode", "|cffffffffDamage, DPS, Heal, HPS, Threat" }
  ...
  frame.btnAnnounce = CreateFrame("Button", "TerrorMeterAnnounce", frame)
  ...
  frame.btnAnnounce:RegisterForClicks("LeftButtonUp", "RightButtonUp")
  frame.btnAnnounce.tooltip = {
    "Report to Chat",
    { "|cffffffffLeft Click", "|cffaaaaaaReport to current chat"},
    { "|cffffffffRight Click", "|cffaaaaaaShow chat menu"},
  }
  ...
  -- Create report menu buttons
  frame.btnReportRaid = CreateFrame("Button", nil, frame)
  frame.btnReportRaid:SetPoint("LEFT", frame.btnAnnounce, "LEFT", 0, -18)
  frame.btnReportRaid:SetFrameStrata("TOOLTIP")
  frame.btnReportRaid:SetHeight(16)
  frame.btnReportRaid:SetWidth(50)
  frame.btnReportRaid:SetBackdrop(backdrop)
  frame.btnReportRaid:SetBackdropColor(.2,.2,.2,1)
  frame.btnReportRaid:SetBackdropBorderColor(.4,.4,.4,1)
  frame.btnReportRaid:Hide()
  frame.btnReportRaid.caption = frame.btnReportRaid:CreateFontString(nil, "OVERLAY", "GameFontWhite")
  frame.btnReportRaid.caption:SetFont(STANDARD_TEXT_FONT, 9)
  frame.btnReportRaid.caption:SetText("Raid")
  frame.btnReportRaid.caption:SetAllPoints()
  frame.btnReportRaid:SetScript("OnEnter", btnEnter)
  frame.btnReportRaid:SetScript("OnLeave", btnLeave)
  frame.btnReportRaid:SetScript("OnClick", function()
    ReportToChat(frame, "RAID")
    frame.btnReportRaid:Hide()
    frame.btnReportParty:Hide()
    frame.btnReportGuild:Hide()
    frame.btnReportSay:Hide()
  end)

  frame.btnReportParty = CreateFrame("Button", nil, frame)
  frame.btnReportParty:SetPoint("LEFT", frame.btnAnnounce, "LEFT", 0, -34)
  frame.btnReportParty:SetFrameStrata("TOOLTIP")
  frame.btnReportParty:SetHeight(16)
  frame.btnReportParty:SetWidth(50)
  frame.btnReportParty:SetBackdrop(backdrop)
  frame.btnReportParty:SetBackdropColor(.2,.2,.2,1)
  frame.btnReportParty:SetBackdropBorderColor(.4,.4,.4,1)
  frame.btnReportParty:Hide()
  frame.btnReportParty.caption = frame.btnReportParty:CreateFontString(nil, "OVERLAY", "GameFontWhite")
  frame.btnReportParty.caption:SetFont(STANDARD_TEXT_FONT, 9)
  frame.btnReportParty.caption:SetText("Party")
  frame.btnReportParty.caption:SetAllPoints()
  frame.btnReportParty:SetScript("OnEnter", btnEnter)
  frame.btnReportParty:SetScript("OnLeave", btnLeave)
  frame.btnReportParty:SetScript("OnClick", function()
    ReportToChat(frame, "PARTY")
    frame.btnReportRaid:Hide()
    frame.btnReportParty:Hide()
    frame.btnReportGuild:Hide()
    frame.btnReportSay:Hide()
  ...
  frame.btnReportGuild = CreateFrame("Button", nil, frame)
  frame.btnReportGuild:SetPoint("LEFT", frame.btnAnnounce, "LEFT", 0, -50)
  frame.btnReportGuild:SetFrameStrata("TOOLTIP")
  frame.btnReportGuild:SetHeight(16)
  frame.btnReportGuild:SetWidth(50)
  frame.btnReportGuild:SetBackdrop(backdrop)
  frame.btnReportGuild:SetBackdropColor(.2,.2,.2,1)
  frame.btnReportGuild:SetBackdropBorderColor(.4,.4,.4,1)
  frame.btnReportGuild:Hide()
  frame.btnReportGuild.caption = frame.btnReportGuild:CreateFontString(nil, "OVERLAY", "GameFontWhite")
  frame.btnReportGuild.caption:SetFont(STANDARD_TEXT_FONT, 9)
  frame.btnReportGuild.caption:SetText("Guild")
  frame.btnReportGuild.caption:SetAllPoints()
  frame.btnReportGuild:SetScript("OnEnter", btnEnter)
  frame.btnReportGuild:SetScript("OnLeave", btnLeave)
  frame.btnReportGuild:SetScript("OnClick", function()
    ReportToChat(frame, "GUILD")
    frame.btnReportRaid:Hide()
    frame.btnReportParty:Hide()
    frame.btnReportGuild:Hide()
    frame.btnReportSay:Hide()
  ...
  frame.btnReportSay = CreateFrame("Button", nil, frame)
  frame.btnReportSay:SetPoint("LEFT", frame.btnAnnounce, "LEFT", 0, -66)
  frame.btnReportSay:SetFrameStrata("TOOLTIP")
  frame.btnReportSay:SetHeight(16)
  frame.btnReportSay:SetWidth(50)
  frame.btnReportSay:SetBackdrop(backdrop)
  frame.btnReportSay:SetBackdropColor(.2,.2,.2,1)
  frame.btnReportSay:SetBackdropBorderColor(.4,.4,.4,1)
  frame.btnReportSay:Hide()
  frame.btnReportSay.caption = frame.btnReportSay:CreateFontString(nil, "OVERLAY", "GameFontWhite")
  frame.btnReportSay.caption:SetFont(STANDARD_TEXT_FONT, 9)
  frame.btnReportSay.caption:SetText("Say")
  frame.btnReportSay.caption:SetAllPoints()
  frame.btnReportSay:SetScript("OnEnter", btnEnter)
  frame.btnReportSay:SetScript("OnLeave", btnLeave)
  frame.btnReportSay:SetScript("OnClick", function()
    ReportToChat(frame, "SAY")
    frame.btnReportRaid:Hide()
    frame.btnReportParty:Hide()
    frame.btnReportGuild:Hide()
    frame.btnReportSay:Hide()
  ...
  frame.btnAnnounce:SetScript("OnClick", function()
    if arg1 == "RightButton" then
      -- Show/hide menu
      if frame.btnReportRaid:IsShown() then
        frame.btnReportRaid:Hide()
        frame.btnReportParty:Hide()
        frame.btnReportGuild:Hide()
        frame.btnReportSay:Hide()
      else
        frame.btnReportRaid:Show()
        frame.btnReportParty:Show()
        frame.btnReportGuild:Show()
        frame.btnReportSay:Show()
      end
    else
      -- Left click - report to current chat
