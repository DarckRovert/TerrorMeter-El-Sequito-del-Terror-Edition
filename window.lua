...
local function spairs(t, order)
  -- collect the keys
  for i in pairs(spairs_keys) do spairs_keys[i] = nil end
  table.setn(spairs_keys, 0)
  ...
  if order then
    table.sort(spairs_keys, function(a,b) return order(t, a, b) end)
  else
    table.sort(spairs_keys)
  end
